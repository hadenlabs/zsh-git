<!-- Space: Projects -->
<!-- Parent: ZshGit -->
<!-- Title: Contributing GithubFlow ZshGit -->
<!-- Label: ZshGit -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-git project on [GitHub](https://github.com/hadenlabs/zsh-git), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-git/pulls).
...
To follow the instructions in this guide and start contributing to zsh-git project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-git.git
```

Now your **upstream** points to **hadenlabs/zsh-git**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-git
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-git/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
